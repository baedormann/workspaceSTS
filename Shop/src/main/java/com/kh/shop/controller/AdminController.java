...
public class AdminController {
	 ...
	 * 
	 * @GetMapping("/categoryManage") public String categoryManage(Model model,
	 * String menuCode) {
	 * 
	 * }
	 */
	...
	//서브메뉴에서 상품등록 클릭 시 실행
	@GetMapping("/regItem")
	public String regItem(Model model, String subMenuCode, String menuCode){
		//카테고리 목록 조회
