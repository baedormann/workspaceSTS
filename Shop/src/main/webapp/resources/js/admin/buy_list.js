function selectBuyListDetail(orderNum){
	$.ajax({
		...
		success: function(result) {
			...
			//var modalBodies = document.getElementById('buyInfoModal').getElementsByClassName('modal=body');
			...
			str += '						<tr>                                                             ';
			str += '							<td>1</td>                                                   ';
			str += '							<td><img width="50px;" alt=""                                ';
			str += '								src="/resources/images/' + result[i].itemVO.imgList[0].attachedImgName + '">';
			str += '							</td>                                                        ';
