	...
	<div class="col text-end">
		<c:choose>
			<c:when test="${not empty sessionScope.loginInfo }">
				...
				<span>
					<a href="/cart/cartList?memId=${sessionScope.loginInfo.memId }">장바구니</a>
				</span>
				<span>
					...
					<div class="collapse navbar-collapse" id="navbarNav">
						<ul class="navbar-nav">
							...
							<c:forEach items="${categoryList }" var="category">
								<li class="nav-item">
									<a class="nav-link <c:if test="${selectedCategory eq category.cateCode}">active</c:if>" href="/item/itemList?cateCode=${category.cateCode }">${category.cateName }</a>
								</li>
							</c:forEach>
